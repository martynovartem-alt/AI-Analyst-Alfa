...
> **Проект вышел в build-фазу.** DL-19 «Отчёт-бот» собран по дев-плану и запущен пилотом на реальной команде — первый MVP после отгруженных DL-0/DL-1. Единственный поток разработки занят. Полный расклад по всем гипотезам с решением по каждой — в `hip.md`.

- **Аналитики данных (#1):** 3 живых интервью + живой контакт с тимлидом ЧБ-1 (Соколова). Выжившие гипотезы — DL-19/DL-18 (Jira-автоматизация), DL-17/DL-20 (классификация/кластеризация). **DL-19 — в пилоте у команды с 10.09.2026** (дев-план `MVP_DevPlans_30_26.md`, MVP-1); DL-18/DL-17 — планы готовы, не начаты. OST — в `OST_DataAnalysts_28_26.md`.
...
5. Обновить строку этого `DL-N` в `CLAUDE.md → Decision Log Index`
6. Обновить сквозной бэклог — `HypothesisBacklog.md` и `HypothesisBacklog_v2.md` разом — петля замкнулась
...
| Build-фаза (аналитики) | `MVP_DevPlans_30_26.md` (дев-планы DL-19/DL-18/DL-17; **MVP-1 по DL-19 в пилоте с 10.09.2026**) · `OST_DataAnalysts_28_26.md` (Opportunity Solution Tree) · `tasks_dl19/` (разбиение задач DL-19) |
