...
- **Бизнес-аналитик (новый трек):** порождён живыми PM-интервью — PRD/CJM/BPMN в этом банке пишет БА, а не PM. Реестр `Hypotheses_BusinessAnalysts_35_26.md` переадресует PM-гипотезы (H-BA-1/H-BA-2); 2 синтетических CustDev (27–28.08) + **первое живое интервью 28.08.2026** (Ольга Серегина → DL-32…DL-35): подтверждён хэндофф БА→сис.аналитик (ICE 144), 3-й подряд disconfirm метрик-гипотезы H-BA-2 (ICE 24), усилен кросс-ролевой каталог контактов H-PM-23 (ICE 210), и зарегистрирована новая гипотеза H-BA-6 — AI-агент по внутренним источникам (Confluence/Jira/АБУК), самая громкая боль респондента, пропущенная обеими синтетическими персонами.
