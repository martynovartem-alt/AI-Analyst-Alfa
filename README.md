...
| Персоны для синтетического CustDev | `SKILL/DataAnalysts`, `SKILL/ScenarioWriters`, `SKILL/ProductDesigners`, `SKILL/ProductManagers`, `SKILL/InternalCustomer`, `SKILL/BusinessAnalysts`                                                                                                                                                            |
