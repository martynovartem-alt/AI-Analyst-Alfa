...
|---|---|---|---|
| Data analysts (DL-1 team + 2 more teams) | **Have access** | 3 live interviews done (Вахрушева 09.07, Миниахматова 14.07, Плеханова 22.07) → cycles DL-5…DL-19. Strongest surviving: DL-19, DL-18 (Jira automation), DL-17, DL-11 (incident/anomaly investigation). Most narrative/report hypotheses killed. DL-5 open but weakened (low frequency, 2/2 respondents) | **#1** |
