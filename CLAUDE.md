...
| `decision-log.md` | **Canonical Decision Log** — full DL-0…DL-31 entries with evidence |
...
| `Live_interview/BusinessAnalysts/Interview_BusinessAnalysts_35_26_H1_BA_v2_synt.md` | **BA interview scenario (v2, 28.08.2026) — executed 28.08.2026** on first respondent Ольга Серегина; v1 structure + hypotheses H-BA-3…5 + synthetic predictions from both personas (`SYNT PERSONA ANSWER:`), now with `LIVE ANSWER:`/`Сверка:` filled in per question → verdicts feed DL-32…35 |
| `Live_interview/BusinessAnalysts/Interview_BusinessAnalysts_35_26_Seregina.md` | **Live transcript** — Ольга Серегина, БА команды доработки CRM SFA, 28.08.2026 (interviewer: Арман Урбисинов) → DL-32…DL-35, 1st live BA respondent |
...
| DL-19 | Auto-collect statuses for weekly team report | Data analysts / Аналитики данных (team lead) | 🟡 Pivot | «Вся пятница» ≈ 8h/wk (n=1); "draft + gaps" scenario confirmed by a 2nd real team lead (Соколова, тимлид ЧБ-1 — Плеханова's team; 23.07, initially mislogged as synthetic); next: 1-sprint draft-report pilot + measure bot-ping response rate. PO working notes 07.08 (Урбисинов): new validation question — awareness vs time (do analysts know native Jira JQL/due-date notifications?) |
...
| DL-32 | BA writes BRD, hands off to system analyst; BPMN drawn by hand; text-drafting already self-served via generic AI (H-BA-1/H-BA-5) | Business analyst / Бизнес-аналитик | 🟡 Pivot | First live BA respondent (Ольга Серегина) — 3rd independent confirmation of the BA→sys.analyst handoff (after DL-21/DL-26), now first-person; narrows hypothesis toward BPMN auto-drafting + internal context access (BRD text generation already DIY-solved). ICE 144 (first-ever for H-BA) |
| DL-33 | Regular metric interpretation not a BA-wide pain — 3rd first-person disconfirmation (H-BA-2) | Business analyst / Бизнес-аналитик | 🔴 Stop (team-specific) | Respondent's team (CRM SFA) has no product metrics to interpret; 3/3 first-person (incl. 2 synthetic) against — pain likely confined to teams with a tracked metric like VOK (DL-28). ICE 140→24 |
| DL-34 | 4th independent source of "can't find the right person/system" — now from BA (H-PM-23) | Business analyst / Бизнес-аналитик (cross-role) | 🟡 Pivot | Named twice unprompted, stronger than BRD/BPMN pain; converges with DL-12 (analysts) and DL-31 (PM, Лаврищенко) — likely a cross-role infra gap, not one role's hypothesis. ICE 60→210 |
| DL-35 | New hypothesis H-BA-6: internal-knowledge RAG agent (Confluence/Jira/АБУК) | Business analyst / Бизнес-аналитик | 🟡 New hypothesis | Respondent's self-named #1 pain, repeated 3× unprompted — missed by both synthetic personas (biggest calibration gap this cycle); internal tool ("Альфаген") already tried and disappointed on this exact retrieval task. ICE 126 |
